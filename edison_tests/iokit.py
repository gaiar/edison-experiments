...
class iot_kit():
    ...
    def __init__(self):
        ...
        # Активируем девайс
        g_device_token = self.activate(aid, device_id, ac)
    ...
    def get_user_id(self):
        ...
        resp = requests.get(url, headers=self.get_user_headers(), proxies=proxies, verify=verify)
        self.check(resp, 200)
        js = resp.json()
    ...
    def create_device(self,account, device_id, device_name):
        ...
        resp = requests.post(url, data=data, headers=self.get_user_headers(), proxies=proxies, verify=verify)
        self.check(resp, 201)
        return resp
    ...
    def generate_activation_code(self,account_id):
        ...
        resp = requests.put(url, headers=self.get_user_headers(), proxies=proxies, verify=verify)
        self.check(resp, 200)
        js = resp.json()
    ...
    def activate(self,account_id, device_id, activation_code):
        ...
        resp = requests.put(url, data=data, headers=self.get_user_headers(), proxies=proxies, verify=verify)
        self.check(resp, 200)
        js = resp.json()
    ...
    def create_component(self,account_id, device_id, component_type_name, name):
        ...
        resp = requests.post(url, data=data, headers=self.get_device_headers(), proxies=proxies, verify=verify)
        self.check(resp, 201)
        js = resp.json()
        return js["cid"]


    def create_observations(self,account_id, device_id, cid, val):
